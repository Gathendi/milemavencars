      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Kenya's trusted car rental service offering reliable and
              affordable vehicle solutions for personal and corporate needs.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">+254 724 636 436</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 MileMaven. All rights reserved. | Made with ❤️ by{" "}
            <Link
              href="https://gathendi.co.ke"
              target="_blank"
